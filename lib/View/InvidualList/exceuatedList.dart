...
class ExecutedList extends StatefulWidget {
  final List<dynamic> infolist;
  ExecutedList(this.infolist);
  @override
  _ExecutedListState createState() => _ExecutedListState();
}

class _ExecutedListState extends State<ExecutedList> {
          ...
          child: Column(children: <Widget>[
            Row(mainAxisAlignment:MainAxisAlignment.start ,children: [
              ...
              Expanded(
                ...
                flex: 1,),
              Expanded(child: Text(widget.infolist[index]),flex: 4,),
              Expanded(
                child: Padding(
              ...
              Expanded(
                child: Padding(
                  ...
                  child: IconButton(icon: Icon(Icons.clear), onPressed: () {
                    widget.infolist.removeAt(index);
                  },iconSize: 25,),
                ),
                flex: 1,)
