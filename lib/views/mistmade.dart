...
class MistMade extends StatefulWidget {
  Diary diary;
  String appTitle;
  MistMade(this.diary,this.appTitle);

  @override
  _MistMadeState createState() => _MistMadeState(this.diary,this.appTitle);
}

class _MistMadeState extends State<MistMade> {

  Diary diary;
  String appTitle;
  DatabaseConfig dbs = new DatabaseConfig();
  _MistMadeState(this.diary,this.appTitle);
