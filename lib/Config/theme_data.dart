...
class PiriorityColors {
  static Color highImp = Colors.red;
  static Color Imp =GradientColors.sea[0];
  static Color medImp = GradientColors.sea[1];
  static Color lessImp = GradientColors.mango[1];
  static Color unImp = kGrey400;
}
