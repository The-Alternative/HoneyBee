...
//
//
//     Future<List> searchDiary(String text) async{
//     List<Diary> _cardlist = [];
//     var dbClient = await db.honeyBee;
//     var sql ="SELECT * FROM $diaryTable Where  $columnAddress LIKE '%$text%'";
...
//     var dbClient = await db.honeyBee;
//     var sql ="SELECT * FROM $diaryTable و";
