...
const mosaope='sdsd';
final List<String> weekDaysList = ['السبت', 'الأحد', 'الأثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة'];
final List<String> textbutton = ['إنشاء مهمة', 'تعليق المهمة', 'تنفيذ'];
final List<String> RepeatList = ['يوم', 'أسبوع', 'شهر'];

final List<String> limitedPeriodList = ['ربع ساعة', 'نصف ساعة', 'ساعة','ساعتان','يوم','يومان','أسبوع'];
final List<String> taskTypes = ['عمل',
  'رياضة', 'قائمة مشتريات', 'اتصال هاتفي', 'موعد طبي', 'مناسبات', 'سفر',
  'مدفوعات', 'ترفيه', 'شخصية', 'زيارة', 'مهمات اخرى'];
final List<String> taskShapes = ['assets/portfolio.png',
  'assets/groupper.png',
  'shopping-list',
  'assets/call.png',
  'assets/doctor.png',
  ...
  'assets/house.png',
  'assets/list.png'];
final List<String> taskPeriority = [
  'عالي الأهمية',
  'هام',
  'متوسط الأهمية',
  'أهمية منخفصة',
  'غير هام'];
final List<String> taskPeriorityShape = [
  'assets/A.png',
  'assets/B.png',
  'assets/C.png',
  'assets/D.png',
  'assets/E.png'];
final int limitUser = 1 ;
const kEmptyColor = 0x0D000000;

/// basic colors
const kTeal50 = Color(0xFFE0F2F1);
const kTeal100 = Color(0xFF254470);

const kTeal400 = Color(0xFF254470);
