                      ...
                      ClipOval(
                        child: Container(
                          ...
                          child: FlatButton(
                            child: null,
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => Diaries()));
                            },
                          ),
                        ),
                      ),
                      ...
                      ClipOval(
                        child: Container(
                          ...
                          child: FlatButton(
                            child: null,
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => ImportEvent()));
                            },
                          ),
                        ),
                      ),
                      ...
                      ClipOval(
                        ...
                        child: Container(
                          ...
                          child: FlatButton(
                            child: null,
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => MistMade()));
                            },
                          ),
                        ),
                      ),
